  ...
  return (
    ...
    >
      <div className="p-6">
        ...
        <div className="text-sm text-gray-500 mb-3 cursor-pointer" onClick={onClick}>
        ...
        <div className="mt-3 mb-4 w-full bg-gray-100 rounded-full h-2 cursor-pointer" onClick={onClick}>
          <motion.div 
